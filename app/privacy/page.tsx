...
export const metadata = {
  title: "Privacy Policy - GoSovereign",
  description:
    "Privacy Policy for GoSovereign - learn how we protect your data and respect your privacy.",
  openGraph: {
    title: "Privacy Policy - GoSovereign",
    description:
      "Privacy Policy for GoSovereign - learn how we protect your data.",
    url: "https://gosovereign.io/privacy",
          ...
          <div className="py-12 md:py-16">
            ...
            <div className="mt-12 pt-8 border-t border-navy-700">
              <p className="text-gray-400">
                ...
                <a
                  href="mailto:privacy@gosovereign.io"
